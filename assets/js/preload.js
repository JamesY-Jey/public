            ...
            a.each(b, function(index, t) {
                ...
                a.each(b[index], function(e, f) {
                    ...
                    "string" != typeof f && (h = a(f).attr("src") || a(f).css("background-image").replace(/^url\((?:"|')?(.*)(?:'|")?\)$/gm, "$1"), i = f), a(g).bind("load error", function(e) {
                        ...
                        d.push(i), a.data(i, "loaded", "error" == e.type ? !1 : !0), c.each instanceof Function && c.each.call(i, d.slice(0)), d.length >= load_img_total && c.all instanceof Function && c.all.call(d), a(this).unbind("load error")
                    }), g.src = h;
                })
            });
